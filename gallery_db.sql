...
--
-- Table structure for table `comments.php`
--

CREATE TABLE IF NOT EXISTS `comments.php` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `comments.php`
--

INSERT INTO `comments.php` (`id`, `username`, `password`, `first_name`, `last_name`, `user_image`) VALUES
...
--
-- Indexes for table `comments.php`
--
ALTER TABLE `comments.php`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `comments.php`
--
ALTER TABLE `comments.php`
